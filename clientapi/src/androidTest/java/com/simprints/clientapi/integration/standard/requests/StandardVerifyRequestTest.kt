...
//class StandardVerifyRequestTest : KoinTest {
//
...
//        ActivityScenario.launch<CommCareActivity>(standardBaseIntentRequest.apply {
...
//        ActivityScenario.launch<CommCareActivity>(standardSuspiciousIntentRequest.apply {
//            action = commcareVerifyAction
//            putExtra(verifyGuidField.key(), verifyGuidField.value())
//        })
//
...
//        ActivityScenario.launch<CommCareActivity>(standardInvalidIntentRequest.apply {
//            action = commcareVerifyAction
//            putExtra(verifyGuidField.key(), verifyGuidField.value())
//        })
//
