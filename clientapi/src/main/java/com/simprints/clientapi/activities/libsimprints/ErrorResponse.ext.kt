...
internal fun ErrorResponse.Reason.libSimprintsResultCode() =
    when(this) {
        ...
        INVALID_STATE_FOR_INTENT_ACTION -> SIMPRINTS_CANCELLED
        ENROLMENT_LAST_BIOMETRICS_FAILED -> SIMPRINTS_CANCELLED
        FACE_LICENSE_MISSING -> SIMPRINTS_CANCELLED
        FACE_LICENSE_INVALID -> SIMPRINTS_CANCELLED
        SETUP_OFFLINE_DURING_MODALITY_DOWNLOAD -> SIMPRINTS_CANCELLED
        SETUP_MODALITY_DOWNLOAD_CANCELLED -> SIMPRINTS_CANCELLED
        FINGERPRINT_CONFIGURATION_ERROR -> SIMPRINTS_CANCELLED
        FACE_CONFIGURATION_ERROR -> SIMPRINTS_CANCELLED
        BACKEND_MAINTENANCE_ERROR -> SIMPRINTS_CANCELLED
    }
