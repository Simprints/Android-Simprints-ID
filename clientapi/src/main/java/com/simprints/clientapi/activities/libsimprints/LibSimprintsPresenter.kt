...
class LibSimprintsPresenter(private val view: LibSimprintsContract.View,
    ...
    override fun handleEnrollResponse(enroll: EnrollResponse) {
        CoroutineScope(Dispatchers.Main).launch {
            ...
            addCompletionCheckEvent(flowCompletedCheck)
            view.returnRegistration(Registration(enroll.guid), sessionEventsManager.getCurrentSession(), flowCompletedCheck)
        }
    }
    ...
    override fun handleVerifyResponse(verify: VerifyResponse) {
        CoroutineScope(Dispatchers.Main).launch {
            ...
            with(verify) {
                ...
                view.returnVerification(verification, sessionEventsManager.getCurrentSession(), flowCompletedCheck)
            }
        }
    }
