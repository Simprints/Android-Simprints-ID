...
Used during the **Compose UI phase (Phase 2)** alongside
[phase2-compose-ui.md](compose-ui.md).
...
- [phase2-compose-ui.md](compose-ui.md) — Compose screen structure, interop shell, and UI tests.
