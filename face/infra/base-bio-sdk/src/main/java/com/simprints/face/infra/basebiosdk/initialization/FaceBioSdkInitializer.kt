...
fun interface FaceBioSdkInitializer {
     ...
     *
     * @param activity some bio SDKs needs the activity to do the initialization, make sure to not capture the activity reference while
     *   implementing this method to avoid memory leaks.
