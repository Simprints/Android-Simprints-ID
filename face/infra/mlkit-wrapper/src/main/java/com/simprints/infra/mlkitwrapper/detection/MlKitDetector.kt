package com.simprints.infra.mlkitwrapper.detection
...
class MlKitDetector @Inject constructor(
    ...
    private fun extractTemplate(mlFace: MLFace, bitmap: Bitmap): Face {
        val template = container.mlKitModel.getFaceEmbedding(bitmap).toBytes()
        return Face(
            ...
            quality = 100f,
            template = template,
            format = container.templateFormat
        )
    }
}
