...
class FaceMatchActivity : AppCompatActivity(R.layout.activity_face_match) {
    ...
    private fun setTextInLayout() {
        face_match_please_wait.text =
            androidResourcesHelper.getString(R.string.face_match_please_wait)
    }
    ...
    private fun renderLoadingCandidates() {
        ...
        face_match_tv_matchingProgressStatus1.text =
            androidResourcesHelper.getString(R.string.face_match_loading_candidates)
    ...
    private fun renderFinished(matchState: Finished) {
        ...
        if (matchState.veryGoodMatches > 0) {
            ...
            face_match_tv_matchingResultStatus1.text = androidResourcesHelper.getStringPlural(
        ...
        if (matchState.goodMatches > 0) {
            ...
            face_match_tv_matchingResultStatus2.text = androidResourcesHelper.getStringPlural(
        ...
        if (matchState.veryGoodMatches < 1 && matchState.goodMatches < 1 || matchState.fairMatches > 1) {
            ...
            face_match_tv_matchingResultStatus3.text = androidResourcesHelper.getStringPlural(
