...
internal class ClientApiViewModelTest {
    ...
    fun `handleIdentifyResponse saves correct events`() = runTest {
        ...
        verify { resultMapper.invoke(withArg { assert(it is ActionResponse.IdentifyActionResponse) }) }
        viewModel.returnResponse.test().assertHasValue()
    }
    ...
    fun `handleConfirmResponse saves correct events`() = runTest {
        ...
        verify { resultMapper.invoke(withArg { assert(it is ActionResponse.ConfirmActionResponse) }) }
        viewModel.returnResponse.test().assertHasValue()
    }
    ...
    fun `handleVerifyResponse saves correct events`() = runTest {
        ...
        verify { resultMapper.invoke(withArg { assert(it is ActionResponse.VerifyActionResponse) }) }
        viewModel.returnResponse.test().assertHasValue()
    }
    ...
    fun `handleExitFormResponse saves correct events`() = runTest {
        ...
        verify { resultMapper.invoke(withArg { assert(it is ActionResponse.ExitFormActionResponse) }) }
        viewModel.returnResponse.test().assertHasValue()
    }
    ...
    fun `handleErrorResponse saves correct events`() = runTest {
        ...
        verify { resultMapper.invoke(withArg { assert(it is ActionResponse.ErrorActionResponse) }) }
        viewModel.returnResponse.test().assertHasValue()
    }
