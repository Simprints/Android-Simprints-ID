...
internal class SetupFragment : Fragment(R.layout.fragment_setup) {
    ...
    private fun getLastCallingPackageName(): String {
        return PreferenceManager.getDefaultSharedPreferences(requireContext())
            .getString(
                getString(com.simprints.infra.resources.R.string.preference_last_calling_package_name_key),
                getString(com.simprints.infra.resources.R.string.default_commcare_package_name),
            ) ?: getString(com.simprints.infra.resources.R.string.default_commcare_package_name)
    }
