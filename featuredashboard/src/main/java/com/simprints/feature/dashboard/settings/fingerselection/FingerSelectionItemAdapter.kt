...
internal class FingerSelectionItemAdapter(
    ...
    class FingerSelectionItemViewHolder(
        ...
        fun bind() {
            ...
            if (getItems()[adapterPosition].removable) {
...
private fun AdapterView<*>.onItemSelectedWithPosition(listener: (position: Int) -> Unit) {
...
private fun AdapterView<*>.disableLongPress() {
