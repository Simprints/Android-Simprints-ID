...
class ObserveFingerprintScanFeedbackUseCaseTest {
    ...
    private lateinit var observeFingerprintScanFeedback: ObserveFingerprintScanFeedbackUseCase
    ...
    fun setup() {
        ...
        observeFingerprintScanFeedback = ObserveFingerprintScanFeedbackUseCase(
            tracker,
            playAudioBeep,
            configManager,
            scannerManager,
    ...
    fun `playBeep should be called when scan completes and audio is enabled`() =
        runTest(testDispatcher) {
           ...
           every { sharedPreferences.getBoolean(any(), any()) } returns true
            ...
            // When
            observeFingerprintScanFeedback(this.backgroundScope, fingerprintSdk)
