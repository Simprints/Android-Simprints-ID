...
class ShowConnectWrapper : ActivityResultContract<Unit, FingerprintConnectResult>() {
    ...
    override fun parseResult(resultCode: Int, intent: Intent?): FingerprintConnectResult = intent
