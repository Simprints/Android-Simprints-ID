...
internal fun ImageSavingStrategy.isImageTransferRequired(): Boolean =
    this != ImageSavingStrategy.NEVER

internal fun ImageSavingStrategy.isEager(): Boolean =
    this == ImageSavingStrategy.EAGER
