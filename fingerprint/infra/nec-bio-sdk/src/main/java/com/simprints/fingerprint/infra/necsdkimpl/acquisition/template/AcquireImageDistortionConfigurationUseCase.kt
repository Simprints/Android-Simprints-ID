...
internal class AcquireImageDistortionConfigurationUseCase @Inject constructor(
    ...
    suspend operator fun invoke(): ByteArray = sharedPreferences.getString(getDistortionConfigurationKey(), null)?.hexToByteArray()
    ...
    private suspend fun acquireImageDistortionConfigurationFromScanner() = fingerprintCaptureWrapperFactory
        .captureWrapper
