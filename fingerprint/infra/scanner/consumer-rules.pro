...
-keep class com.simprints.fingerprint.infra.scanner.v2.domain.main.message.vero.models.* { *; }
-keep class com.simprints.fingerprint.infra.scanner.v2.domain.main.message.un20.models.* { *; }
