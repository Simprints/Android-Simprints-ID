...
class CaptureFingerprintResponse(
    val captureFingerprintResult: CaptureFingerprintResult,
) : Un20Response(Un20MessageType.CaptureFingerprint) {
    override fun getDataBytes(): ByteArray = byteArrayOf(captureFingerprintResult.byte)

    companion object {
        fun fromBytes(data: ByteArray) = CaptureFingerprintResponse(CaptureFingerprintResult.fromBytes(data))
    }
}
