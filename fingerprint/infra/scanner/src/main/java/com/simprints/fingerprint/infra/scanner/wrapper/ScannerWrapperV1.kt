...
internal class ScannerWrapperV1(
     ...
     */
    override fun versionInformation(): ScannerVersion = ScannerVersion(
        hardwareVersion = "",
    ...
    override suspend fun startLiveFeedback() = throw UnavailableVero2FeatureException(UnavailableVero2Feature.LIVE_FEEDBACK)

    override suspend fun stopLiveFeedback() = throw UnavailableVero2FeatureException(UnavailableVero2Feature.LIVE_FEEDBACK)
