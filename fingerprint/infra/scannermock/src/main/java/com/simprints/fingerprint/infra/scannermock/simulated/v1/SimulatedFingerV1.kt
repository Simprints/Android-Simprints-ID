...
enum class SimulatedFingerV1(
    val imageQualityResponse: String = "fa fa fa fa 0e 00 8b 00 63 00 f5 f5 f5 f5 ", // Quality score 99
...
fun SimulatedFinger.toV1(): SimulatedFingerV1 = when (this) {
