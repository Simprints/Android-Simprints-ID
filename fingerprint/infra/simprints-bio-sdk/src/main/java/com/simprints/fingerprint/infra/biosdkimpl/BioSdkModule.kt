...
object SimprintsBioSdkModule {
    ...
    @Provides
    internal fun provideFingerprintImageProvider(
        fingerprintCaptureWrapperFactory: FingerprintCaptureWrapperFactory,
    ): FingerprintImageProvider<Unit, Unit> = FingerprintImageProviderImpl(fingerprintCaptureWrapperFactory)

    @Provides
    internal fun provideFingerprintTemplateProvider(
        fingerprintCaptureWrapperFactory: FingerprintCaptureWrapperFactory,
