...
@Module(includes = [FingerprintDependenciesModule::class])
...
@Module
@InstallIn(ActivityComponent::class)
object FingerprintMatcherModule {

    @Provides
    fun provideFingerprintMatcher(): FingerprintMatcher = FingerprintMatcher.create()
}
