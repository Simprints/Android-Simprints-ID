...
class EventRemoteDataSourceImplAndroidTest {
    ...
    fun setUp() {
        ...
        eventRemoteDataSource = EventRemoteDataSourceImpl(
            SimApiClientFactoryImpl(mockBaseUrlProvider, "some_device","some_version", remoteDbManager, mockk(relaxed = true), testDispatcherProvider, HttpLoggingInterceptor(), okHttpClientBuilder),
            JsonHelper
        )
