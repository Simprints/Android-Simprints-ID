...
import com.simprints.id.data.db.session.eventdata.models.domain.events.AuthorizationEvent
import com.simprints.id.data.db.session.eventdata.models.domain.events.AuthorizationEvent.Result.AUTHORIZED
import com.simprints.id.data.db.session.eventdata.models.domain.events.AuthorizationEvent.UserInfo
import com.simprints.id.data.db.session.eventdata.models.domain.events.ConnectivitySnapshotEvent
import com.simprints.id.data.db.session.eventdata.models.domain.events.Event
