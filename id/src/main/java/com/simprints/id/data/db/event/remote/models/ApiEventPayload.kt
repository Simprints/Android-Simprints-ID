...
fun EventPayload.fromDomainToApi(baseStartTime: Long): ApiEventPayload =
    when (this.type) {
        ...
        ARTIFICIAL_TERMINATION -> ApiArtificialTerminationPayload(this as ArtificialTerminationPayload, baseStartTime)
        AUTHENTICATION -> ApiAuthenticationPayload(this as AuthenticationPayload, baseStartTime)
        CONSENT -> ApiConsentPayload(this as ConsentPayload, baseStartTime)
        ENROLMENT -> ApiEnrolmentPayload(this as EnrolmentPayload, baseStartTime)
        AUTHORIZATION -> ApiAuthorizationPayload(this as AuthorizationPayload, baseStartTime)
        FINGERPRINT_CAPTURE -> ApiFingerprintCapturePayload(this as FingerprintCapturePayload, baseStartTime)
        ONE_TO_ONE_MATCH -> ApiOneToOneMatchPayload(this as OneToOneMatchPayload, baseStartTime)
        ONE_TO_MANY_MATCH -> ApiOneToManyMatchPayload(this as OneToManyMatchPayload, baseStartTime)
        PERSON_CREATION -> ApiPersonCreationPayload(this as PersonCreationPayload, baseStartTime)
        ALERT_SCREEN -> ApiAlertScreenPayload(this as AlertScreenPayload, baseStartTime)
        GUID_SELECTION -> ApiGuidSelectionPayload(this as GuidSelectionPayload, baseStartTime)
        CONNECTIVITY_SNAPSHOT -> ApiConnectivitySnapshotPayload(this as ConnectivitySnapshotPayload, baseStartTime)
        REFUSAL -> ApiRefusalPayload(this as RefusalPayload, baseStartTime)
        CANDIDATE_READ -> ApiCandidateReadPayload(this as CandidateReadPayload, baseStartTime)
        SCANNER_CONNECTION -> ApiScannerConnectionPayload(this as ScannerConnectionPayload, baseStartTime)
        VERO_2_INFO_SNAPSHOT -> ApiVero2InfoSnapshotPayload(this as Vero2InfoSnapshotPayload, baseStartTime)
        INVALID_INTENT -> ApiInvalidIntentPayload(this as InvalidIntentPayload, baseStartTime)
        SUSPICIOUS_INTENT -> ApiSuspiciousIntentPayload(this as SuspiciousIntentPayload, baseStartTime)
        INTENT_PARSING -> ApiIntentParsingPayload(this as IntentParsingPayload, baseStartTime)
        COMPLETION_CHECK -> ApiCompletionCheckPayload(this as CompletionCheckPayload, baseStartTime)
        SESSION_CAPTURE -> ApiSessionCapturePayload(this as SessionCapturePayload)
        FACE_ONBOARDING_COMPLETE -> ApiFaceOnboardingCompletePayload(this as FaceOnboardingCompletePayload, baseStartTime)
        FACE_FALLBACK_CAPTURE -> ApiFaceFallbackCapturePayload(this as FaceFallbackCapturePayload, baseStartTime)
        FACE_CAPTURE -> ApiFaceCapturePayload(this as FaceCapturePayload, baseStartTime)
        FACE_CAPTURE_CONFIRMATION -> ApiFaceCaptureConfirmationPayload(this as FaceCaptureConfirmationPayload, baseStartTime)
        FACE_CAPTURE_RETRY -> ApiFaceCaptureRetryPayload(this as FaceCaptureRetryPayload, baseStartTime)
        SCANNER_FIRMWARE_UPDATE -> ApiScannerFirmwareUpdatePayload(this as ScannerFirmwareUpdatePayload, baseStartTime)
        CALLOUT_CONFIRMATION -> ApiCalloutPayload(this as ConfirmationCalloutPayload, baseStartTime)
        CALLOUT_IDENTIFICATION -> ApiCalloutPayload(this as IdentificationCalloutPayload, baseStartTime)
        CALLOUT_ENROLMENT -> ApiCalloutPayload(this as EnrolmentCalloutPayload, baseStartTime)
        CALLOUT_VERIFICATION -> ApiCalloutPayload(this as VerificationCalloutPayload, baseStartTime)
        CALLOUT_LAST_BIOMETRICS -> ApiCalloutPayload(this as EnrolmentLastBiometricsCalloutPayload, baseStartTime)
        CALLBACK_IDENTIFICATION -> ApiCallbackPayload(this as IdentificationCallbackPayload, baseStartTime)
        CALLBACK_ENROLMENT -> ApiCallbackPayload(this as EnrolmentCallbackPayload, baseStartTime)
        CALLBACK_REFUSAL -> ApiCallbackPayload(this as RefusalCallbackPayload, baseStartTime)
        CALLBACK_VERIFICATION -> ApiCallbackPayload(this as VerificationCallbackPayload, baseStartTime)
        CALLBACK_ERROR -> ApiCallbackPayload(this as ErrorCallbackPayload, baseStartTime)
        CALLBACK_CONFIRMATION -> ApiCallbackPayload(this as ConfirmationCallbackPayload, baseStartTime)
    }
