...
import com.simprints.id.data.db.session.domain.models.events.FingerprintCaptureEvent.FingerprintCapturePayload
import com.simprints.id.data.db.session.domain.models.events.FingerprintCaptureEvent.FingerprintCapturePayload.Result.SKIPPED
...
class PersonCreationEvent(
    ...
    ) : EventPayload(EventPayloadType.PERSON_CREATION) {
