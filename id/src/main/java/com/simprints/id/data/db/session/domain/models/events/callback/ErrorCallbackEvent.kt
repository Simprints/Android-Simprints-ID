...
class ErrorCallbackEvent(
    ...
    ErrorCallbackEventPayload(startTime, reason)) {

    @Keep
    class ErrorCallbackEventPayload(val startTime: Long,
                                    val reason: Reason) : EventPayload(EventPayloadType.CALLBACK_ERROR) {
