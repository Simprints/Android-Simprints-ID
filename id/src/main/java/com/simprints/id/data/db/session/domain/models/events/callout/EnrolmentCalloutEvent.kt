...
class EnrolmentCalloutEvent(
    ...
    EnrolmentCalloutPayload(startTime, projectId, userId, moduleId, metadata)) {

    @Keep
    class EnrolmentCalloutPayload(val startTime: Long,
                                  val projectId: String,
                                  val userId: String,
                                  val moduleId: String,
                                  val metadata: String?) : EventPayload(EventPayloadType.CALLOUT_ENROLMENT)
