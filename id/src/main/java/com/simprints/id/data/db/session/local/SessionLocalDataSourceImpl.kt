...
open class SessionLocalDataSourceImpl(private val appContext: Context,
    ...
    override suspend fun create(sessionEvents: SessionEvents): Completable {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override suspend fun load(query: SessionLocalDataSource.Query): Flow<SessionEvents> {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override suspend fun count(query: SessionLocalDataSource.Query): Int {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
    ...
    override suspend fun delete(query: SessionLocalDataSource.Query) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
