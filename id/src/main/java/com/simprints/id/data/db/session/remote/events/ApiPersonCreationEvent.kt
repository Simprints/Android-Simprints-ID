...
@Keep
class ApiPersonCreationEvent(
    val relativeStartTime: Long,
    val fingerprintCaptureIds: List<String>?,
    val faceCaptureIds: List<String>?
) : ApiEvent(ApiEventType.PERSON_CREATION) {

    constructor(personCreationEvent: PersonCreationEvent) : this(
        personCreationEvent.relativeStartTime ?: 0,
        personCreationEvent.fingerprintCaptureIds,
        personCreationEvent.faceCaptureIds
    )
}
