...
@Database(entities = [DbSubjectsDownSyncOperation::class, DbSubjectsUpSyncOperation::class], version = 2, exportSchema = false)
@TypeConverters(DbSubjectsDownSyncOperation.Converters::class, DbSubjectsUpSyncOperation.Converters::class)
@Keep
