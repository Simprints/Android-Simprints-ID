...
open class SettingsPreferencesManagerImpl(
    ...
    companion object {
        ...
        val GENERAL_CONSENT_OPTIONS_JSON_DEFAULT: String = JsonHelper.jackson.writeValueAsString(com.simprints.id.data.consent.shortconsent.GeneralConsentOptions())

        const val PARENTAL_CONSENT_OPTIONS_JSON_KEY = "ConsentParentalOptions"
        val PARENTAL_CONSENT_OPTIONS_JSON_DEFAULT: String = JsonHelper.jackson.writeValueAsString(com.simprints.id.data.consent.shortconsent.ParentalConsentOptions())
