...
class SerializerModule {
    ...
    @Provides @Singleton @Named("PeopleDownSyncStateSerializer") fun providePeopleDownSyncStateSerializer(): Serializer<PeopleDownSyncState> =EnumSerializer(PeopleDownSyncState::class.java)
