...
//import com.simprints.id.libdata.fb_Person;
//import com.simprints.libdata.models.firebase.fb_RefusalForm;
//import com.simprints.id.libdata.fb_Session;
...
//import static com.simprints.libdata.tools.Routes.userRef;
...
//        Utils.forceSync(FirebaseApp.getInstance()); // NOT COPIED
...
//            return false;
//
//        refusalRef(firebaseApp).push().setValue(new fb_RefusalForm(refusalForm, key.apiKey, userId, sessionId));
//
//        return true;
//    }
//
...
//            return false;
//
//        fb_Person fbPerson = new fb_Person(person, userId, androidId, moduleId);
...
//
//            userRef(firebaseApp, key.apiKey, userId).addListenerForSingleValueEvent(new ValueEventListener() {
//                @Override
//                public void onDataChange(DataSnapshot dataSnapshot) {
//                    fb_User user = dataSnapshot.getValue(fb_User.class);
//                    if (user == null) {
//                        updates.put(userNode(key.userId), new fb_User(key.userId, "androidId", person.getGuid()));
//                    } else {
