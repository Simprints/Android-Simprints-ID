...
class AppResponseBuilderForEnrolLastBiometrics : BaseAppResponseBuilder() {
    ...
    private fun getCoreResponseForEnrolLastBiometrics(results: List<Step.Result?>): CoreEnrolLastBiometricsResponse =
        results.filterIsInstance(CoreEnrolLastBiometricsResponse::class.java).lastOrNull()
