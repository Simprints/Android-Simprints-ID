...
sealed class SyncTaskParameters(open val projectId: String, open val moduleId: String?, open val userId: String?) : ProgressTaskParameters {
    ...
    data class UserSyncTaskParameters(override val projectId: String, override val userId: String) : SyncTaskParameters(projectId, userId, null)

    data class ModuleIdSyncTaskParameters(override val projectId: String, override val moduleId: String) : SyncTaskParameters(projectId, null, moduleId)
