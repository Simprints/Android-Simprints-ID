...
class EventDownSyncCountWorker(context: Context, params: WorkerParameters) : CoroutineWorker(context, params) {

    private val workManager = WorkManager.getInstance(context)

    override suspend fun doWork(): Result {
        workManager.cancelAllWorkByTag("TAG_PEOPLE_SYNC_WORKER_TYPE_DOWN_COUNTER")
