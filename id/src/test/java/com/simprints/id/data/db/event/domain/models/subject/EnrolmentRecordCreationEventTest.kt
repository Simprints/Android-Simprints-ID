...
class EnrolmentRecordCreationEventTest {
    ...
    fun create_EnrolmentRecordCreationEvent() {
        ...
        val event = EnrolmentRecordCreationEvent(
            1, SOME_GUID1, DEFAULT_PROJECT_ID, DEFAULT_MODULE_ID, SOME_GUID2, listOf(FACE, FINGERPRINT), listOf(fingerprintReference, faceReference))
        ...
        assertThat(event.labels).containsExactly(
            ...
            ModesLabel(listOf(FACE, FINGERPRINT))
        )
        ...
        with(event.payload as EnrolmentRecordCreationPayload) {
            ...
            assertThat(biometricReferences).containsExactly(listOf(fingerprintReference, faceReference))
        }
    }
}
