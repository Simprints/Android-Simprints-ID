...
class EventDownSyncOperationFactoryImplTest {
    ...
    val result = EventsDownSyncOperationResult(COMPLETE, LAST_EVENT_ID, LAST_SYNC_TIME)
    ...
    fun testOpFromDomainToDb() {
        ...
        with(op.fromDomainToDb()) {
            assertThat(id.key).isEqualTo(DbEventsDownSyncOperationKey(DEFAULT_PROJECT_ID, DEFAULT_MODES, null).key)
