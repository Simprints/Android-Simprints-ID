...
import com.simprints.id.services.scheduledSync.subjects.master.SubjectsSyncStateProcessorImplTest.Companion.DOWNLOADED
import com.simprints.id.services.scheduledSync.subjects.master.SubjectsSyncStateProcessorImplTest.Companion.TO_DOWNLOAD
import com.simprints.id.services.scheduledSync.subjects.master.SubjectsSyncStateProcessorImplTest.Companion.TO_UPLOAD
import com.simprints.id.services.scheduledSync.subjects.master.SubjectsSyncStateProcessorImplTest.Companion.UNIQUE_DOWN_SYNC_ID
import com.simprints.id.services.scheduledSync.subjects.master.SubjectsSyncStateProcessorImplTest.Companion.UNIQUE_SYNC_ID
import com.simprints.id.services.scheduledSync.subjects.master.SubjectsSyncStateProcessorImplTest.Companion.UNIQUE_UP_SYNC_ID
import com.simprints.id.services.scheduledSync.subjects.master.SubjectsSyncStateProcessorImplTest.Companion.UPLOADED
...
private fun createDownSyncDownloaderWorker(state: WorkInfo.State,
    ...
    createWorkInfo(
        state,
        workDataOf(SubjectsDownSyncDownloaderWorker.OUTPUT_DOWN_SYNC to DOWNLOADED),
        createCommonDownSyncTags(uniqueMasterSyncId, uniqueSyncId) + listOf(tagForType(DOWNLOADER)),
        workDataOf(SubjectsDownSyncDownloaderWorker.PROGRESS_DOWN_SYNC to DOWNLOADED),
        id
    )
...
private fun createUpSyncUploaderWorker(state: WorkInfo.State,
    ...
    createWorkInfo(
        state,
        workDataOf(SubjectsUpSyncUploaderWorker.OUTPUT_UP_SYNC to UPLOADED),
        createCommonUpSyncTags(uniqueMasterSyncId, uniqueSyncId) + listOf(tagForType(UPLOADER)),
        workDataOf(SubjectsUpSyncUploaderWorker.PROGRESS_UP_SYNC to UPLOADED),
        id
    )
