...
internal data class ApiVero2Configuration(
    ...
    fun toDomain(): Vero2Configuration = Vero2Configuration(
        qualityThreshold,
    ...
    enum class ImageSavingStrategy {
        ...
        fun toDomain(): Vero2Configuration.ImageSavingStrategy = when (this) {
    ...
    enum class CaptureStrategy {
        ...
        fun toDomain(): Vero2Configuration.CaptureStrategy = when (this) {
    ...
    enum class LedsMode {
        ...
        fun toDomain(): Vero2Configuration.LedsMode = when (this) {
    ...
    data class ApiVero2FirmwareVersions(
        ...
        fun toDomain(): Vero2Configuration.Vero2FirmwareVersions = Vero2Configuration.Vero2FirmwareVersions(cypress, stm, un20)
    }
}
