...
internal class EnrolmentRecordLocalDataSourceImpl @Inject constructor(
    ...
    override suspend fun performActions(actions: List<SubjectAction>, project: Project) {
    ...
    private fun TokenizableString.tokenizeIfNecessary(tokenKeyType: TokenKeyType, project: Project) = when(this) {
