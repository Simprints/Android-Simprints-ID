...
internal fun SubjectBiometrics.toDomain() = Subject(
    ...
    fingerprintSamples = biometricSamples.filterNot { it.fingerIdentifier == null }.map { it.toFingerprintSample() },
    faceSamples = biometricSamples.filter { it.fingerIdentifier == null }.map { it.toFaceSample() },
)
