...
import com.simprints.infra.eventsync.sync.down.tasks.EventDownSyncProgress
...
internal class CommCareEventSyncTask @Inject constructor(
    ...
    fun downSync(
        ...
        try {
            ...
            // TODO(milen): handle permission for the worker
            // TODO(milen): missing permission results in worker success!?
