...
internal const val OUTPUT_FAILED_BECAUSE_SIGN_IN_REQUIRED = "OUTPUT_FAILED_BECAUSE_SIGN_IN_REQUIRED"
...
internal fun WorkInfo.didFailBecauseReloginRequired(): Boolean =
    this.outputData.getBoolean(OUTPUT_FAILED_BECAUSE_RELOGIN_REQUIRED, false)

internal fun WorkInfo.didFailBecauseCloudIntegration(): Boolean =
...
internal fun WorkInfo.didFailBecauseTooManyRequests(): Boolean =
    this.outputData.getBoolean(OUTPUT_FAILED_BECAUSE_TOO_MANY_REQUESTS, false)

internal fun WorkInfo.getEstimatedOutageTime(): Long =
