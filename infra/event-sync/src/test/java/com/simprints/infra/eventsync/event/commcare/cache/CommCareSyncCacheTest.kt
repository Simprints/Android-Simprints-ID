...
class CommCareSyncCacheTest {
    ...
    fun setUp() {
        ...
        commCareSyncCache = CommCareSyncCache(commCareSyncDao, testDispatcher)
    }

    @Test
    fun `addSyncedCase should call dao insert with timestamp`() = runTest(testDispatcher) {
        // Arrange
        val caseId = "case-123"
    ...
    @Test
    fun `getSimprintsId should return id when entity exists`() = runTest(testDispatcher) {
        // Arrange
        val caseId = "case-123"
    ...
    @Test
    fun `getSimprintsId should return null when entity does not exist`() = runTest(testDispatcher) {
        // Arrange
    ...
    @Test
    fun `removeSyncedCase should call dao deleteByCaseId`() = runTest(testDispatcher) {
        // Arrange
    ...
    @Test
    fun `getAllSyncedCases should return list of case entities`() = runTest(testDispatcher) {
        // Arrange
    ...
    @Test
    fun `getAllSyncedCases should return empty list when no entities`() = runTest(testDispatcher) {
        // Arrange
    ...
    @Test
    fun `clearAllSyncedCases should call dao clearAll`() = runTest(testDispatcher) {
        // Arrange
