...
import com.simprints.infra.events.event.domain.models.EventType.Companion.CALLOUT_CONFIRMATION_V3_KEY
...
import com.simprints.infra.events.event.domain.models.EventType.Companion.CALLOUT_IDENTIFICATION_V3_KEY
import com.simprints.infra.events.event.domain.models.EventType.Companion.CALLOUT_LAST_BIOMETRICS_KEY
import com.simprints.infra.events.event.domain.models.EventType.Companion.CALLOUT_LAST_BIOMETRICS_V3_KEY
...
@JsonSubTypes(
    ...
    JsonSubTypes.Type(value = ConfirmationCalloutEventV2::class, name = CALLOUT_CONFIRMATION_KEY),
    JsonSubTypes.Type(value = ConfirmationCalloutEventV3::class, name = CALLOUT_CONFIRMATION_V3_KEY),
    JsonSubTypes.Type(value = EnrolmentCalloutEventV2::class, name = CALLOUT_ENROLMENT_KEY),
    JsonSubTypes.Type(value = EnrolmentCalloutEventV3::class, name = CALLOUT_ENROLMENT_V3_KEY),
    JsonSubTypes.Type(value = EnrolmentLastBiometricsCalloutEventV2::class, name = CALLOUT_LAST_BIOMETRICS_KEY),
    JsonSubTypes.Type(value = EnrolmentLastBiometricsCalloutEventV3::class, name = CALLOUT_LAST_BIOMETRICS_V3_KEY),
    JsonSubTypes.Type(value = IdentificationCalloutEventV2::class, name = CALLOUT_IDENTIFICATION_KEY),
    JsonSubTypes.Type(value = IdentificationCalloutEventV3::class, name = CALLOUT_IDENTIFICATION_V3_KEY),
    JsonSubTypes.Type(value = VerificationCalloutEventV2::class, name = CALLOUT_VERIFICATION_KEY),
    JsonSubTypes.Type(value = VerificationCalloutEventV3::class, name = CALLOUT_VERIFICATION_V3_KEY),
