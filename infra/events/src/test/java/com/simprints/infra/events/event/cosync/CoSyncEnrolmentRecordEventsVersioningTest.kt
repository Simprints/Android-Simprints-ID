...
import com.simprints.infra.events.event.cosync.v1.EnrolmentRecordCreationEventV1
import com.simprints.infra.events.event.cosync.v1.EnrolmentRecordCreationPayloadV1
import com.simprints.infra.events.event.cosync.v1.ExternalCredentialTypeV1
import com.simprints.infra.events.event.cosync.v1.ExternalCredentialV1
import com.simprints.infra.events.event.cosync.v1.FaceReferenceV1
import com.simprints.infra.events.event.cosync.v1.FaceTemplateV1
import com.simprints.infra.events.event.cosync.v1.FingerprintReferenceV1
import com.simprints.infra.events.event.cosync.v1.FingerprintTemplateV1
import com.simprints.infra.events.event.cosync.v1.SampleIdentifierV1
...
class CoSyncEnrolmentRecordEventsVersioningTest {
    ...
    fun `roundtrip preserves basic event data`() {
        val original = CoSyncEnrolmentRecordEventsV1(
            events = listOf(
                EnrolmentRecordCreationEventV1(
                    id = "event-1",
                    payload = EnrolmentRecordCreationPayloadV1(
                        subjectId = "subject-1",
                        projectId = "project-1",
                        moduleId = TokenizableStringV1.Raw("module-1"),
                        attendantId = TokenizableStringV1.Tokenized("encrypted-attendant"),
                    ),
                ),
            ),
        )
            ...
            events = listOf(
                EnrolmentRecordCreationEventV1(
                    ...
                    payload = EnrolmentRecordCreationPayloadV1(
                        ...
                        projectId = "project-1",
                        moduleId = TokenizableStringV1.Raw("module-1"),
                        attendantId = TokenizableStringV1.Raw("attendant-1"),
                        biometricReferences = listOf(
                            FaceReferenceV1(
                                id = "ref-1",
                                templates = listOf(FaceTemplateV1(template = "dGVtcGxhdGU=")),
                                format = "NEC_5",
                            ),
                        ),
                    ),
            ...
            events = listOf(
                EnrolmentRecordCreationEventV1(
                    ...
                    payload = EnrolmentRecordCreationPayloadV1(
                        ...
                        attendantId = TokenizableStringV1.Raw("attendant-1"),
                        biometricReferences = listOf(
                            FingerprintReferenceV1(
                                id = "ref-2",
                                templates = listOf(
                                    FingerprintTemplateV1(
                                        template = "ZmluZ2VycHJpbnQ=",
                                        finger = SampleIdentifierV1.LEFT_INDEX_FINGER,
                                    ),
                                ),
                                format = "ISO_19794_2",
                            ),
                ...
                EnrolmentRecordCreationEventV1(
                    ...
                    payload = EnrolmentRecordCreationPayloadV1(
                        ...
                        externalCredentials = listOf(
                            ExternalCredentialV1(
                                id = "cred-1",
                                value = TokenizableStringV1.Tokenized("encrypted-value"),
                                subjectId = "subject-1",
                                type = ExternalCredentialTypeV1.NHISCard,
                            ),
                        ),
                    ),
                ),
