...
class EventMigration12to13Test {
    ...
    companion object {
        ...
        private val OLD_EVENT =
            """
            {"id":"d256e644-ce5b-4ec5-8909-3a372a930206","labels":{"projectId":"9WNCAbWVNrxttDe5hgwb","sessionId":"2bdc1145-cbec-4e6a-ac8a-61c1e5b53bb4","deviceId":"d294a268b0d54f58"},"payload":{"startTime":1706534485916,"eventVersion":1,"integration":"STANDARD","type":"INTENT_PARSING","endTime":0,"endTime":1706534528165},"type":"INTENT_PARSING"}
            """.trimIndent()

        private val NEW_EVENT =
            """
            {"id":"d256e644-ce5b-4ec5-8909-3a372a930206","projectId":"9WNCAbWVNrxttDe5hgwb","sessionId":"2bdc1145-cbec-4e6a-ac8a-61c1e5b53bb4","payload":{"startTime":{"ms":1706534485916,"isTrustworthy":false,"msSinceBoot":null},"eventVersion":2,"integration":"STANDARD","type":"INTENT_PARSING","endTime":null,"endTime":{"ms":1706534528165,"isTrustworthy":false,"msSinceBoot":null}},"type":"INTENT_PARSING"}
            """.trimIndent()
    }
}
