...
class EventMigration9To10Test {
    ...
    companion object {
        ...
        private const val EVENT_JSON_OLD =
            "{\"id\":\"id\",\"labels\":{\"projectId\":\"projectId\",\"sessionId\":\"sessionId\",\"deviceId\":\"deviceId\"},\"payload\":{\"payload\":{\"startTime\":0,\"eventVersion\":2,\"subjectId\":\"subjectId\",\"projectId\":\"projectId\",\"moduleId\":\"moduleId\",\"attendantId\":\"attendantId\",\"personCreationEventId\":\"personCreationEventId\",\"type\":\"ENROLMENT_V2\",\"endTime\":0},\"param1\":\"param1\",\"param2\":94,\"startTime\":0,\"eventVersion\":2,\"type\":\"ENROLMENT_V2\",\"endTime\":0},\"type\":\"ENROLMENT_V2\"}"
        private const val EVENT_JSON_NEW =
            "{\"id\":\"id\",\"labels\":{\"projectId\":\"projectId\",\"sessionId\":\"sessionId\",\"deviceId\":\"deviceId\"},\"payload\":{\"payload\":{\"startTime\":0,\"eventVersion\":2,\"subjectId\":\"subjectId\",\"projectId\":\"projectId\",\"moduleId\":{\"className\":\"TokenizableString.Raw\",\"value\":\"moduleId\"},\"attendantId\":{\"className\":\"TokenizableString.Raw\",\"value\":\"attendantId\"},\"personCreationEventId\":\"personCreationEventId\",\"type\":\"ENROLMENT_V2\",\"endTime\":0},\"param1\":\"param1\",\"param2\":94,\"startTime\":0,\"eventVersion\":2,\"type\":\"ENROLMENT_V2\",\"endTime\":0},\"type\":\"ENROLMENT_V2\"}"
    }
}
