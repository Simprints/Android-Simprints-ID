...
internal fun ConsentConfiguration.ConsentEnrolmentVariant.toProto(): ProtoConsentConfiguration.ConsentEnrolmentVariant =
    when (this) {
...
internal fun ProtoConsentConfiguration.toDomain(): ConsentConfiguration =
...
internal fun ProtoConsentConfiguration.ConsentEnrolmentVariant.toDomain(): ConsentConfiguration.ConsentEnrolmentVariant =
    when (this) {
