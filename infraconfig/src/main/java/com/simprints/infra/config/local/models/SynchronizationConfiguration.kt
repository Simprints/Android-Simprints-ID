...
internal fun SynchronizationConfiguration.toProto(): ProtoSynchronizationConfiguration =
...
internal fun SynchronizationConfiguration.Frequency.toProto(): ProtoSynchronizationConfiguration.Frequency =
    when (this) {
...
internal fun ProtoSynchronizationConfiguration.toDomain(): SynchronizationConfiguration =
...
internal fun ProtoSynchronizationConfiguration.Frequency.toDomain(): SynchronizationConfiguration.Frequency =
    when (this) {
