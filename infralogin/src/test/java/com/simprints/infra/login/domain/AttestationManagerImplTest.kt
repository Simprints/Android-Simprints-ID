...
class AttestationManagerImplTest {
    ...
    companion object {
        ...
        private val DECODED_NONCE = Base64.decode(NONCE, Base64.NO_WRAP)
    ...
    fun `should return the attestation`() = runTest(UnconfinedTestDispatcher()) {
        ...
        every { attestationResponse.jwsResult } returns VALID_JWS_RESULT


        val attestation = attestationManagerImpl.requestAttestation(NONCE)
