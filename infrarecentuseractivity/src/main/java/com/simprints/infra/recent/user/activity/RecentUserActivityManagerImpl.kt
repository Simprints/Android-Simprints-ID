...
internal class RecentUserActivityManagerImpl @Inject constructor(
    ...
    override suspend fun updateRecentUserActivity(
        update: suspend (t: RecentUserActivity) -> RecentUserActivity
    ): RecentUserActivity = localSource.updateRecentUserActivity(update)
