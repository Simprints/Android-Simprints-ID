...
def run_instrumented_tests_command(dir_path: str, device: Device):
    return f'{dir_path}/{GRADLEW} connected{SIMPRINTS_ID_ANDROID_TESTS_VARIANT_NAME.capitalize()}AndroidTest mergeAndroidReports --continue -Pdevices={device.device_id} --info'
